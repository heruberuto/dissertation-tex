...
```
cd existing_repo
git remote add origin https://gitlab.fel.cvut.cz/factchecking/studie-bertik.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.fel.cvut.cz/factchecking/studie-bertik/-/settings/integrations)
