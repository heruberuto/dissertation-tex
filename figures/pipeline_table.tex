...
\caption{Comparison of Pipeline Scores on Dev and Test Sets. Q, Q+A are Hu-METEOR scores against gold data, AVeriTeC scores {are calculated as referred in section~\ref{avscore} thresholded at 0.25}. \"{Full-featured} pipelines use the all the improvement techniques introduced in section~\ref{sec:system}, while the simplified pipeline omits the dynamic few-shot learning, answer-type-tuning and Likert-scale confidence emulation described in section~\ref{sec:generation}}
