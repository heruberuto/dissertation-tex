...
Another interactive application App Search \todo{screen} developed by Jan Drchal~\cite{mlynar} demonstrates our best-performing models for the whole fact-checking tasks, integrating the XLM-RoBERTas trained on \FCZNLI data.
