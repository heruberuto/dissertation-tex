...
\subsection{\CTK}
\label{sec:analysis-postprocessing}
...
Due to our cross-annotation design (Section~\ref{sec:cross-annotations}), we had generously sized sample of independently annotated labels in our hands.
...
\revision{For the comparison with \cite{fever2018} and \cite{norregaard2021danfever}, we also list a 4-way Fleiss' $\kappa$-agreement~\cite{fleiss1971measuring} calculated on a sample of 7.5\% claims.}
%todo mention theirs
