...
The LLaMA weights are, however, published under a restrictive license that prohibits republishing the model weights even after tuning its parameters, which limits the fine-tunes to publishing delta- or xor-weights that can not be used without the \textsf{Meta}'s permission.
