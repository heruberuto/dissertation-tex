...
This chapter surveys the evolution from BERT‑style transfer learning to instruction‑following LLMs that often outperform smaller fine‑tuned models even without additional training~\cite{devlin2019bert,gpt4,llama,vicuna}. We then review efficiency methods that make fine‑tuning multi‑billion‑parameter models on a single GPU practical and discuss their relevance to our work.
